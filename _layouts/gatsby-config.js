...
module.exports = {
  ...
  siteMetadata: {
    ...
    title: `povGeoData Knowladge Base`, // Replace it with your site's title
    author: `TBD`, // Replace it with your name
    description: `Collection of data and methods used in poverty analysis`, // Replace it with your site's description
  },
  plugins: [
    {
